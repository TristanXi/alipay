...
public @interface Compensable {
    ...
    class DefaultTransactionContextEditor implements TransactionContextEditor {
        ...
        public static TransactionContext getTransactionContextFromArgs(Object[] args) {
            ...
            for (Object arg : args) {
                if (arg != null && com.tristan.exam.alipay.tranfer.model.TransactionContext.class.isAssignableFrom(arg.getClass())) {

                    transactionContext = (com.tristan.exam.alipay.tranfer.model.TransactionContext) arg;
                }
            }
